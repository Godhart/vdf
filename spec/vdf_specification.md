...
Порядок тэгов м.б. любым, повторения тэгов за исключением некоторых не допускаются.
...
Если после # следует !, то это отменяет тэг, если он был определён ранее глобально
